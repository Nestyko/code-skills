...
Fork from: [![skills.sh](https://skills.sh/b/mattpocock/skills)](https://skills.sh/mattpocock/skills)

Skills for Engineering AI Workflow, enforce best practices and scale with AI.
...
3. Run `/setup-nestor-skills` in your agent. It will:
   - Ask you which issue tracker you want to use (GitHub, Jira, or local files)
